...
export const translations: Record<Locale, TranslationStrings> = {
  es: {
    ...
    submitSuccess: "Registro enviado correctamente. Recibirás el manifest por email.",
    submitError: "Error al enviar el registro. Inténtalo de nuevo.",
    gdprConsent:
      "Acepto la Política de Privacidad y consiento el tratamiento de mis datos personales y los de mis acompañantes con la única finalidad de tramitar el Despacho de Pasajeros ante la Capitanía Marítima conforme a la Ley de Navegación Marítima. Responsable: Náutica Elite. Destinatarios: Capitanía Marítima y Aseguradora del Buque.",
  ...
  en: {
    ...
    submitSuccess: "Registration sent successfully. You will receive the manifest by email.",
    submitError: "Failed to submit registration. Please try again.",
    gdprConsent:
      "I accept the Privacy Policy and consent to the processing of my personal data and that of my companions for the sole purpose of processing the Passenger Manifest before the Maritime Captaincy in accordance with the Maritime Navigation Law. Data Controller: Náutica Elite. Recipients: Maritime Captaincy and Vessel Insurer.",
  ...
  fr: {
    ...
    submitSuccess: "Enregistrement envoyé avec succès. Vous recevrez le manifeste par email.",
    submitError: "Erreur lors de l'envoi. Veuillez réessayer.",
    gdprConsent:
      "J'accepte la politique de confidentialité et consens au traitement de mes données personnelles et de celles de mes accompagnants dans le seul but de traiter le manifeste des passagers auprès de la Capitainerie Maritime conformément à la loi sur la navigation maritime. Responsable: Náutica Elite. Destinataires: Capitainerie Maritime et Assureur du Navire.",
  ...
  de: {
    ...
    submitSuccess: "Registrierung erfolgreich gesendet. Sie erhalten das Manifest per E-Mail.",
    submitError: "Fehler beim Senden. Bitte versuchen Sie es erneut.",
    gdprConsent:
      "Ich akzeptiere die Datenschutzerklärung und willige in die Verarbeitung meiner personenbezogenen Daten und der meiner Begleiter ein, und zwar ausschließlich zum Zweck der Bearbeitung der Passagierliste bei der Maritimen Kapitänskommandantur gemäß dem Seeschifffahrtsgesetz. Verantwortlicher: Náutica Elite. Empfänger: Maritime Kapitänskommandantur und Schiffsversicherer.",
  ...
  it: {
    ...
    submitSuccess: "Registrazione inviata con successo. Riceverai il manifest via email.",
    submitError: "Errore durante l'invio. Riprova.",
    gdprConsent:
      "Accetto l'Informativa sulla privacy e acconsento al trattamento dei miei dati personali e di quelli dei miei accompagnatori al solo scopo di elaborare il Manifesto dei Passeggeri presso la Capitaneria Marittima ai sensi della Legge sulla Navigazione Marittima. Titolare del trattamento: Náutica Elite. Destinatari: Capitaneria Marittima e Assicuratore della Nave.",
  ...
  pt: {
    ...
    submitSuccess: "Registo enviado com sucesso. Receberá o manifesto por email.",
    submitError: "Erro ao enviar o registo. Tente novamente.",
    gdprConsent:
      "Aceito a Política de Privacidade e consinto no tratamento dos meus dados pessoais e dos meus acompanhantes com o único propósito de tramitar o Manifesto de Passageiros perante a Capitania Marítima, de acordo com a Lei de Navegação Marítima. Responsável: Náutica Elite. Destinatários: Capitania Marítima e Seguradora do Navio.",
